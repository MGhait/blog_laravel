            ...
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item @yield('category-active') submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('site.category') }}">Food</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('site.category') }}">Bussiness</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('site.category') }}">Travel</a></li>
                </ul>
              </li>
